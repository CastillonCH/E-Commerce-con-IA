  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-3 border-b border-slate-100 px-4 py-3 sm:flex-nowrap sm:gap-6 sm:px-6">
        ...
        <Link
          href="/"
          className="shrink-0 text-2xl font-extrabold tracking-tight text-slate-900"
        >
        ...
        <form
          action="/"
          className="order-3 flex w-full min-w-0 items-center gap-2 sm:order-none sm:ml-auto sm:w-auto sm:max-w-xs sm:flex-1"
        >

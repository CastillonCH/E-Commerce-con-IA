...
const TOPICS = [
  {
    ...
    subtitle: "Consulta el estado de tu envío en tiempo real.",
  },
  {
    icon: RotateCcw,
    title: "Cambios y devoluciones",
    subtitle: "Tienes 30 días para solicitar un cambio.",
  },
  {
    icon: CreditCard,
    title: "Métodos de pago",
    subtitle: "Tarjetas, billeteras digitales y hasta 12 cuotas.",
  },
  {
    icon: MessageCircle,
    title: "Habla con nosotros",
    subtitle: "Usa el asistente virtual o escríbenos por WhatsApp.",
  },
];
  ...
  return (
    <div className="mx-auto w-full max-w-4xl flex-1 px-4 py-14 sm:px-6">
      ...
      <p className="mt-2 text-sm text-slate-500">
        Encuentra respuestas rápidas o abre el asistente virtual en la esquina
        inferior derecha.
      </p>
